...
Patched version of SATA-unsupported.kext to allow macOS to detect AMD SATA controller and disks connected to it. Tested on macOS 12 Monterey. Use recommended only if your computer can't read internal Disks when in macOS.
